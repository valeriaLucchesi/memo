...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("testRavltOpenFl", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("testRavltOpenFl", null, 800, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "39";
		app.meta["company"] = "valeria";
		app.meta["file"] = "testRavltOpenFl";
		app.meta["name"] = "testRavltOpenFl";
		app.meta["packageName"] = "testRavltOpenFl";
